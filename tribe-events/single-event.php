...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<div class="tribe-events-schedule tribe-clearfix" style="margin-bottom:3px;">
	...
	<?php if(!empty($fields[$location_label])){ ?>
		<div class="">
			<span>
			...
			<span style="font-size:12px;"><?php echo is_array($fields[$location_label])?implode(', ',$fields[$location_label]):$fields[$location_label]; ?></span>
		</div>
	<?php } ?>
